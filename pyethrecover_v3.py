...
def __main__():
    ...
    if args.use_rules:
        ...
        replacement_rules.add(pwgen.Rule("c", "C"))
        replacement_rules.add(pwgen.Rule("C", "c"))
        replacement_rules.add(pwgen.Rule("d", "D"))
        replacement_rules.add(pwgen.Rule("D", "d"))
        replacement_rules.add(pwgen.Rule("e", "3E"))
        replacement_rules.add(pwgen.Rule("E", "3e"))
        replacement_rules.add(pwgen.Rule("f", "F"))
        replacement_rules.add(pwgen.Rule("F", "f"))
        replacement_rules.add(pwgen.Rule("g", "G"))
        replacement_rules.add(pwgen.Rule("G", "g"))
        replacement_rules.add(pwgen.Rule("h", "H"))
        replacement_rules.add(pwgen.Rule("H", "h"))
        replacement_rules.add(pwgen.Rule("i", "!I"))
        replacement_rules.add(pwgen.Rule("I", "!i"))
        replacement_rules.add(pwgen.Rule("j", "J"))
        replacement_rules.add(pwgen.Rule("J", "j"))
        replacement_rules.add(pwgen.Rule("k", "K"))
        replacement_rules.add(pwgen.Rule("K", "k"))
        replacement_rules.add(pwgen.Rule("l", "L1"))
        replacement_rules.add(pwgen.Rule("L", "l"))
        replacement_rules.add(pwgen.Rule("m", "M"))
        replacement_rules.add(pwgen.Rule("M", "m"))
        replacement_rules.add(pwgen.Rule("n", "N"))
        replacement_rules.add(pwgen.Rule("N", "n"))
        replacement_rules.add(pwgen.Rule("o", "O0"))
        replacement_rules.add(pwgen.Rule("O", "o0"))
        replacement_rules.add(pwgen.Rule("p", "P"))
        replacement_rules.add(pwgen.Rule("P", "p"))
        replacement_rules.add(pwgen.Rule("q", "Q"))
        replacement_rules.add(pwgen.Rule("Q", "q"))
        ...
        replacement_rules.add(pwgen.Rule("T", "t7"))
        replacement_rules.add(pwgen.Rule("u", "U"))
        replacement_rules.add(pwgen.Rule("U", "u"))
        replacement_rules.add(pwgen.Rule("v", "V"))
        replacement_rules.add(pwgen.Rule("V", "v"))
        replacement_rules.add(pwgen.Rule("w", "W"))
        replacement_rules.add(pwgen.Rule("W", "w"))
        replacement_rules.add(pwgen.Rule("x", "X"))
        replacement_rules.add(pwgen.Rule("X", "x"))
        replacement_rules.add(pwgen.Rule("y", "Y"))
        replacement_rules.add(pwgen.Rule("Y", "y"))
        replacement_rules.add(pwgen.Rule("z", "Z"))
        replacement_rules.add(pwgen.Rule("Z", "z"))
